 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'JOHNVERY SAS.');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'JOHNVERY SAS.');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Johnvery administracion');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "por suitapp.net - suiteapp.net\nwww.johnvery.com");
