$(function(){
	APP.Entities.Referencia = {};
	APP.Entities.Referencia = {
		Mostrar:function(){
			APP.View.load('referencia', 'referencia/form/frm-buscarReferencia').success(function(_html){
		        var dialog = new BootstrapDialog({
		        	cssClass:'frm-buscarReferencia',
		            buttons: [{
		                ...
		                action: function(dialog) {
		                    ...
		                    APP.Entities.Referencia.Guardar({
		                ...
		                action: function(dialog) {
							...
							APP.Entities.Referencia.Actualizar({
		                ...
		                action:function(dialog){
					        BootstrapDialog.show({
					            ...
					            buttons: [{
					                ...
					                cssClass: 'btn-primary',
					                action: function(dlg){
					                   var http =  APP.Entities.Referencia.Borrar({
					                    	id:$('#tblUbicacion').find('.selectedRow').data('id')
					                    });
